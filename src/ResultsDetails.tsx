...
function ResultsDetails() {
    ...
    const heat2: Heat = {
        ...
        startTime: new Date(),
        host: "Tufts",
        finishOrder: [MIT, Harvard, Brown, Northeastern, Dartmouth, WPI, Tufts, Bates]
    }
    const heat3: Heat = {
        ...
        startTime: new Date(),
        host: "Bates",
        finishOrder: [Tufts, Bates, WPI, MIT, Harvard, Brown, Northeastern, Dartmouth]
    }
    const heat4: Heat = {
        title: "BREAK",
    ...
    const heat5: Heat = {
        ...
        startTime: new Date(),
        host: "Tufts",
        finishOrder: [Bates, Tufts, WPI, MIT, Harvard, Brown, Northeastern, Dartmouth]
    }
    const heat6: Heat = {
        ...
        startTime: new Date(),
        host: "Bates",
        finishOrder: [WPI, Bates, Tufts, MIT, Harvard, Brown, Northeastern, Dartmouth]
    }
    const heat7: Heat = {
        ...
        startTime: new Date(),
        host: "MIT",
        finishOrder: [MIT, Harvard, Brown, Northeastern, Dartmouth, Yale, Princeton, Columbia, Penn, Cornell]
    }
    const heat8: Heat = {
        ...
        startTime: new Date(),
        host: "Harvard",
        finishOrder: [Harvard, Brown, Northeastern, Dartmouth, Yale, Princeton, Columbia, Penn, Cornell, MIT]
    }
    const heat9: Heat = {
        title: "BREAK",
        status: HeatStatus.OFFICIAL,
    ...
    const heat10: Heat = {
        ...
        startTime: new Date(),
        host: "Northeastern",
        finishOrder: [Yale, Princeton, Columbia, Penn, Cornell, MIT, Harvard, Brown, Northeastern, Dartmouth]
    }
    const heat11: Heat = {
        ...
        startTime: new Date(),
        host: "Dartmouth",
        finishOrder: [Dartmouth, Yale, Princeton, Columbia, Penn, Cornell, MIT, Harvard, Brown, Northeastern]
    }
    ...
    const testRegatta: Regatta = {
        ...
        heats: [
            heat1, heat2, heat3, heat4, heat5, heat6, heat7, heat8, heat9, heat10, heat11
        ]
