    ...
    return (
        <>
            <div className="self-stretch h-[51px] flex-col justify-start items-start gap-[5px] flex">
                <div className="text-red-900 text-2xl font-bold text-red">{props.title}</div>
            ...
            <div
                className="self-stretch w-full grow shrink basis-0 bg-neutral-50 rounded-[10px] shadow flex-col justify-start items-start flex overflow-x-scroll">
                <div
                    className="self-stretch p-2.5 bg-neutral-700 justify-between items-start inline-flex w-fit lg:w-full">
                ...
                <div
                    className="self-stretch grow shrink basis-0 flex-col justify-start items-start flex p-1 w-fit lg:w-full">
                    {props.finishOrder
