...
function RaceCard(props: RaceCardProps) {
  return (
    <Link href={"/regattas/results/" + props.uuid}>
      <div className="w-[379px] h-auto p-[15px] bg-neutral-50 rounded-[20px] border border-zinc-800 border-opacity-20 flex-col justify-start items-start gap-[5px] inline-flex">
        <div className="text-zinc-800 text-opacity-50 text-base font-normal capitalize">
          {props.type}
        </div>
