            ...
            <div className="min-w-screen min-h-screen overflow-x-hidden">
                ...
                <div className="flex flex-row p-5 gap-4">
                    ...
                    <div className="w-auto flex flex-col gap-5">
                        ...
                        {regattas.filter((regatta) => regatta.status != RegattaStatus.UPCOMING).sort((a, b) => b.date.getTime() - a.date.getTime()).map((regatta) => {
                            return (
                                <RaceCard
                                    uuid={regatta.uuid}
                                    name={regatta.name}
                        ...
                        {regattas.filter((regatta) => regatta.status == RegattaStatus.UPCOMING).map((regatta) => {
                            return (
                                <RaceCard
                                    uuid={regatta.uuid}
                                    name={regatta.name}
