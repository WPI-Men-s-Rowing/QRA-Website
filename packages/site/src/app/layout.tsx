        ...
        <footer>
            <div className="w-full h-[88.68px] p-2.5 bg-neutral-700 justify-between items-center inline-flex">
                <div className="flex-col justify-start items-start gap-[5px] inline-flex">
                    <div
                        className="text-neutral-50 text-[10px] font-normal">©️ {(new Date().getFullYear())} Quinsigamond
                        Rowing
                        Association, Inc.
                    </div>
                    <div className="justify-start items-start gap-[5px] inline-flex">
                        <div className="text-neutral-50 text-[10px] font-normal">Photos courtesy of</div>
                        <div
                            className="text-blue-500 text-[10px] font-normal underline">SportGraphics.com
                        </div>
                    </div>
                    <div className="self-stretch text-neutral-50 text-[10px] font-normal">Website
                        developed by Bob Nyce, Ian Wright, and Emerson Shatouhy
                    </div>
                </div>
                <div className="flex-col justify-start items-start gap-2.5 inline-flex">
                    <Image className="w-[39px] h-[29.34px]" src={qraLogo} alt={"QRA Logo"}/>
                    <Image className="w-[37.41px] h-[29.34px]" src={sportsGraphicsLogo} alt={"Sports Graphics Logo"}/>
                </div>
            </div>
        </footer>
        </body>
